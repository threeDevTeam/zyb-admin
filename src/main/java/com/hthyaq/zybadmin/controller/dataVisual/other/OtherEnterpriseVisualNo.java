...
@RestController
@RequestMapping("/otherEnterpriseVisual/no")
public class OtherEnterpriseVisualNo {
    //危害因素、企业规模
    /*
     ...
     */
    @GetMapping("/option11")
    public List<Double> option11(String year, String type, String name1, String name2, String name3) {
    ...
    public List<Twenty> option11Detail(String year, String type, String name1, String name2, String name3) {
    ...
    */
    @GetMapping("/option12")
    public Map<String, List<Double>> option12(String year, String type, String name1, String name2, String name3) {
    ...
    public List<Twenty> option12Detail(String year, String type, String name1, String name2, String name3) {
        List<Twenty> list = Lists.newArrayList();
        if ("危害因素".equals(type)) {
     ...
     */
    @GetMapping("/option13")
    public Map<String, List<Double>> option13(String year, String type, String name1, String name2, String name3) {
        Map<String, List<Double>> map = Maps.newHashMap();
        if ("危害因素".equals(type)) {
    ...
    public List<Twenty> option13Detail(String year, String type, String name1, String name2, String name3) {
        List<Twenty> list = Lists.newArrayList();
        if ("危害因素".equals(type)) {
            List<String> dangerList = DataVisualCacheUtil.getDangerList();
            for (String s : dangerList) {
 ...
 */
    @GetMapping("/option14")
    public Map<String, List<Double>> option14(String year, String type, String name1, String name2, String name3) {
        Map<String, List<Double>> map = Maps.newHashMap();
    ...
    public List<Twenty> option14Detail(String year, String type, String name1, String name2, String name3) {
        List<Twenty> list = Lists.newArrayList();
        if ("危害因素".equals(type)) {
            List<String> dangerList = DataVisualCacheUtil.getDangerList();
            for (String s : dangerList) {
    ...
    //行政区划、登记注册类型、所属行业
    @GetMapping("/option21")
    public Map<String, List<Double>> option21(String year, String type, String name1, String name2, String name3) {
        Map<String, List<Double>> map = Maps.newHashMap();
        //['粉尘', '化学因素', '物理因素', '放射性因素', '生物因素']
        List<Double> list1 = Lists.newArrayList();
        List<Double> list2 = Lists.newArrayList();
        ...
        int size = 0;
        if ("行政区划".equals(type)) {
            size = DataVisualCacheUtil.getAreaChildren(name1, name2, name3).size();
        } else if ("登记注册类型".equals(type)) {
            size = DataVisualCacheUtil.getRegisterTypeList().size();
        } else if ("所属行业".equals(type)) {
            size = DataVisualCacheUtil.getIndustryList().size();
        }
    ...
    public List<Twenty> option21Detail(String year, String type, String name1, String name2, String name3) {
        List<Twenty> list = Lists.newArrayList();
        List<String> list2 = null;
        if ("行政区划".equals(type)) {
            list2 = DataVisualCacheUtil.getAreaStrChildren(name1, name2, name3);
        } else if ("登记注册类型".equals(type)) {
    ...
    //行政区划、登记注册类型、所属行业
    @GetMapping("/option22")
    public Map<String, List<Double>> option22(String year, String type, String name1, String name2, String name3) {
        Map<String, List<Double>> map = Maps.newHashMap();
        //['检测率', '达标率', '损失率']
        List<Double> list1 = Lists.newArrayList();
        List<Double> list2 = Lists.newArrayList();
    ...
    public List<Twenty> option22Detail(String year, String type, String name1, String name2, String name3) {
        List<Twenty> list = Lists.newArrayList();
        List<String> list2 = null;
        if ("行政区划".equals(type)) {
            list2 = DataVisualCacheUtil.getAreaStrChildren(name1, name2, name3);
    ...
    //行政区划、登记注册类型、所属行业
    @GetMapping("/option23")
    public Map<String, List<Double>> option23(String year, String type, String name1, String name2, String name3) {
    ...
    public List<Twenty> option23Detail(String year, String type, String name1, String name2, String name3) {
        List<Twenty> list = Lists.newArrayList();
        List<String> list2 = null;
        if ("行政区划".equals(type)) {
            list2 = DataVisualCacheUtil.getAreaStrChildren(name1, name2, name3);
    ...
    //行政区划、登记注册类型、所属行业
    @GetMapping("/option24")
    public Map<String, List<Double>> option24(String year, String type, String name1, String name2, String name3) {
    ...
    public List<Twenty> option24Detail(String year, String type, String name1, String name2, String name3) {
        List<Twenty> list = Lists.newArrayList();
        List<String> list2 = null;
        if ("行政区划".equals(type)) {
            list2 = DataVisualCacheUtil.getAreaStrChildren(name1, name2, name3);
     ...
     */
    @GetMapping("/option25")
    public Map<String, List<Double>> option25(String year, String type, String name1, String name2, String name3) {
    ...
    public List<Twenty> option25Detail(String year, String type, String name1, String name2, String name3) {
        List<Twenty> list = Lists.newArrayList();
        List<String> list2 = null;
        if ("行政区划".equals(type)) {
            list2 = DataVisualCacheUtil.getAreaStrChildren(name1,name2,name3);
