...
@RestController
@RequestMapping("/otherGovVisual/no")
public class OtherGovVisualNo {
    //表2-29 职业健康监管资源统计分析表
    @GetMapping("/option1")
    public List<GovSix> option1(String year, String name1, String name2, String name3) {
    ...
    public List<Twenty> option2Detail(String year, String name1, String name2, String name3) {
        ...
        List<String> nationList = DataVisualCacheUtil.getAreaStrChildren(name1, name2, name3);
    ...
    @GetMapping("/option5")
    public Map<String, List<Integer>> option5(String year, String name1, String name2, String name3) {
        Map<String, List<Integer>> map = Maps.newHashMap();
        //技术服务机构、健康检查机构、诊断机构
        List<Integer> list1 = Lists.newArrayList();
        List<Integer> list2 = Lists.newArrayList();
