...
@RestController
@RequestMapping("/otherServiceVisual/no")
public class OtherServiceVisualNo {

    //危害因素
    //    表1  作业场所职业病危害因素检测情况统计分析表
    @GetMapping("/option11")
    public List<NameValueDouble> option11(String year, String type, String name1, String name2, String name3) {
    ...
    //表4-职业卫生技术服务机构统计分析表
    @GetMapping("/option24")
    public List<GovEight> option24(String year, String type, String name1, String name2, String name3) {
        List<AreaOfDic> areaList = DataVisualCacheUtil.getAreaChildren(name1, name2, name3);
        List<BaseOfDic> registerList = DataVisualCacheUtil.getRegisterTypeList();
    ...
    //表5-职业健康检查机构统计分析表
    @GetMapping("/option25")
    public List<GovSix> option25(String year, String type, String name1, String name2, String name3) {
        List<AreaOfDic> areaList = DataVisualCacheUtil.getAreaChildren(name1, name2, name3);
        List<BaseOfDic> registerList = DataVisualCacheUtil.getRegisterTypeList();
    ...
    //表6-职业病诊断机构统计分析表
    @GetMapping("/option26")
    public List<ServiceFive> option26(String year, String type, String name1, String name2, String name3) {
        List<AreaOfDic> areaList = DataVisualCacheUtil.getAreaChildren(name1, name2, name3);
        List<BaseOfDic> registerList = DataVisualCacheUtil.getRegisterTypeList();
